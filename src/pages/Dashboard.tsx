...
// 1. Reusable Stat Card Component (Internal for now)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard 
          title="Avg. Student Stress" 
          value="7.2/10" 
          subtext="vs last week" 
          trend="+12%"
          icon={TrendingUp} 
          color="bg-stress-high" // Red for high stress
        />
        <StatCard 
          ...
          trend="4 Urgent"
          icon={Clock} 
          color="bg-primary-500" // Blue for standard
        />
        <StatCard 
        ...
        <StatCard 
          ...
          trend="High Load"
          icon={AlertTriangle} 
          color="bg-stress-medium" // Amber for warning
        />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-slate-100 shadow-sm p-6">
          ...
          <div className="mt-4 p-4 bg-orange-50 border border-orange-100 rounded-lg flex items-start gap-3">
             ...
             <div>
                <p className="text-sm font-semibold text-orange-700">High Stress Alert: Thursday</p>
                <p className="text-xs text-orange-600">3 Major Exams & 2 Project Deadlines overlap for CS Dept.</p>
             </div>
          </div>
        </div>
              ...
              <div key={item} className="flex items-start gap-3 pb-4 border-b border-slate-50 last:border-0 last:pb-0">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2 mt-2">
                    <button className="text-xs bg-primary-50 text-primary-600 px-2 py-1 rounded font-medium hover:bg-primary-100">
                      View
                    </button>
                    <button className="text-xs border border-slate-200 text-slate-600 px-2 py-1 rounded font-medium hover:bg-slate-50">
                      Dismiss
                    </button>
                  </div>
                </div>
